...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .lista-ingredientes(data-aos="fade-right")
            .d-flex.flex-wrap.align-items-center
              ...
              .col-auto.d-none.d-md-flex
                img(src="@/assets/curso/temas/tema1/img-5.svg" alt="imagen decorativa").img65
        .col-lg-5.col-xl-4
    ...
    .d-flex.flex-wrap.mx-auto(style="background-color: #E8F5D5")
      ...
      .px-4.py-3.col-lg-8.mb-0(data-aos="fade-left")
        img(src="@/assets/curso/temas/tema1/img-10.svg" style="max-width: 85px" alt="imagen decorativa").mb-3
