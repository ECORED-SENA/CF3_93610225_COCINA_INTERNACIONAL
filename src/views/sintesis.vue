  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-10.mb-5.bgs.p-4.brad
        figure
          img(src="@/assets/curso/sintesis.svg", alt="Síntesis de  la cocina europea como una fusión de tradiciones, ingredientes locales y técnicas únicas. Se destacan tres regiones: Europa del Norte, con platos como gravlax, blinis, lutefisk y köttbullar; Europa Central, con borsch, fondue, choucroute y pierogi; y Europa del Sur, con preparaciones como paella, coq au vin, risotto milanés y ensalada griega. ")
      .col-auto
